...
class ws_client(QObject):
    ...
    def connect(self, ip = None, port = None):
        ...
        for key in self.sub_list:
            print("This is sublist " + sub_list)
    ...
    def subscribe(self, topic_name, msgs_data, pub_topic_name ='', rate = 0,queue_length=0):
        ...
        print(self.sub_list[topic_name][0])

    def _subscribe(self, topic_name, msgs_data, rate = 0.0, queue_length = 0):
        if rate > 0:
                rate = 1000.0/rate
			
                pub_msg = {'op': 'subscribe','topic': topic_name,'msgs_data': msgs_data._type,'throttle_rate': rate,'queue_length ': queue_length}
